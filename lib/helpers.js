...
helpers.processPromise = (fileOperation, errorObj, parametersArray) => {
  return new Promise( async (resolve, reject) => {
    try {
      let fulfillment = await fileOperation(...parametersArray);
...
helpers.setRejectedObj = (statusCode, payload) => {
