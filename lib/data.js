...
lib.create = function(dir, file, data, callback){
  ...
  fs.open(constructedFilePath, 'wx', function(err, fileDescriptor){
...
lib.read = function(dir, file, callback){
  ...
  fs.readFile(constructedFilePath, 'utf8', function(err, data){
    if(!err && data){
...
lib.update = function (dir, file ,data, callback){
  ...
  fs.open(constructedFilePath, 'r+', function(err, fileDescriptor){
...
lib.delete = function(dir, file, callback){
  ...
  fs.unlink(constructedFilePath, function(err){
